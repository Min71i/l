...
if(!file_exists('config.json')){
	$token = readline('Hi MATLOB Enter Token: ');
			...
			if(isset($update->message)){
              ...
              $bot->sendvideo([ 'chat_id'=>$chatId,
                  'video'=>"https://t.me/bbbbbuuuuu1/733",
                   'caption'=>'🇪🇬التفعيل بواسطة مطلوب-🇪🇬
Matlob 🇪🇬',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'تسجيل بحساب وهمي🌿','callback_data'=>'login']],
                         [['text'=>" لشراء الملف من المطور ", 'url'=>"@F_7_U"]],[['text'=>" قناة المطور انضم الأن", 'url'=>"@PR2_NET"]],
                      ]
                  ])
              ]); 
...
لشراء نسخه مراسلةة المطور 👁‍🗨',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'▫️| 『 المطور』','url'=>'@PR2_NET']],
                          [['text'=>"قناة المطور  ℡ᴖ̈💜✨⋮", 'url'=>"@PR2_NET"]],
