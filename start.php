...
$edit = bot('sendMessage',[
    'chat_id'=>$id,
    'text'=>"- *بداء الفحص روح العب ومطلوب هيجبلك متاحات ✅
                    ...
                    if(checkMail($mail, -10)) {
                        ...
                        if ($inInsta !== false) {
                            // if($config['filter'] <= $follow){
                                ...
                                $following = $info['ff'];
                                $media = $info['m'];
                                bot('sendMessage', ['disable_web_page_preview' => true, 'chat_id' => $id, 'text' => "MATLOB.✅
 🇪🇬مطلوب روق عليك وجبلك متاح ابسط🇪🇬
...
----------------------------
 [@F_7_U✹ @PR2_NET ○ @F_7_U○ارسل اثبات صيد هنا ]",                                
                                'parse_mode'=>'markdown']);
